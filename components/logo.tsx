...
export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" className="group flex min-w-0 items-center gap-3.5" aria-label="BAG-DNA OS home">
      <span className="relative grid h-14 w-14 shrink-0 place-items-center overflow-hidden rounded-2xl border border-white/15 bg-white/[.08] p-1 shadow-[0_8px_24px_rgba(0,0,0,.2),inset_0_1px_0_rgba(255,255,255,.12)] backdrop-blur-xl transition duration-300 group-hover:scale-[1.03] group-hover:bg-white/[.11] md:h-16 md:w-16">
        <Image
