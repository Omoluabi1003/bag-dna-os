...
export const navItems = [
  ...
  { label: "Bag Registry", href: "/registry" },
  { label: "Custody Ledger", href: "/custody" },
  { label: "Live Map", href: "/digital-twin" },
  { label: "Risk Operations", href: "/risk" },
  { label: "Scanner", href: "/scanner" },
  { label: "Claims Evidence", href: "/claims" },
  { label: "Pilot Control", href: "/pilot" },
