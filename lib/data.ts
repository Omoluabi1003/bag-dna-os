...
export const navItems = [
  ...
  { label: "Event Graph", href: "/event-graph" },
  { label: "Memory Graph", href: "/memory-graph" },
  { label: "Collective Intelligence", href: "/collective-intelligence" },
  ...
  { label: "Airport Reputation", href: "/airport-reputation" },
  { label: "Insurance Intelligence", href: "/insurance-intelligence" },
